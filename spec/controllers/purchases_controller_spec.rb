...
describe PurchasesController do
  ...
  let(:valid_attributes) { { "seller_id" => "1" } }
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved purchase as @purchase" do
        ...
        post :create, {:purchase => { "seller_id" => "invalid value" }}, valid_session
        expect(assigns(:purchase)).to be_a_new(Purchase)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested purchase" do
        ...
        expect_any_instance_of(Purchase).to receive(:update).with({ "seller_id" => "1" })
        put :update, {:id => purchase.to_param, :purchase => { "seller_id" => "1" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the purchase as @purchase" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        allow_any_instance_of(Purchase).to receive(:save).and_return(false)
        put :update, {:id => purchase.to_param, :purchase => { "seller_id" => "invalid value" }}, valid_session
        expect(assigns(:purchase)).to eq(purchase)
      end
